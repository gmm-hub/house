...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/client/css/admin.css">
</head>
<body>
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <a href="${pageContext.request.contextPath}/client/welcome.jsp" target="iframe">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
            <li class="layui-nav-item" lay-unselect="" style="">
                <a href="javascript:void(0)">
                    <cite>${loginUser.username}，欢迎回来</cite>
    ...
    <div class="layui-side">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="${pageContext.request.contextPath}/client/addHouse.jsp" target="iframe">发布房源信息</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/house/findUserHouse/${loginUser.uid}.do" target="iframe">我发布的房源</a></dd>
                </dl>
            </li>
        </ul>
    </div>
    <div class="layui-body">
        <iframe src="${pageContext.request.contextPath}/client/welcome.jsp" width="100%" height="100%" frameborder="0"
